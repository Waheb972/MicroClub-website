...
<p>
  ...
  <!-- <div class="SESSION"> <h3> example</h3> 
    ...
    <nav class="navbar">
      <img class="logo" src="/images/Logo-MC-Blue-nobackground_2.png" alt="logo" />
      <ul class="menu-list">
    ...
    <main>
      <div class="container">
        <div class="imgcontainer">
          <img src="/images/undraw_online_connection_6778.svg" alt="" />
          <h1>JOIN US</h1>
          <div class="seccontainer">
            <p class="para">
              Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quos
              aliquid nam quasi repellat vitae odit amet provident, fugit
              consequuntur doloremque corrupti quisquam voluptatem reprehenderit
              dicta blanditiis? Quos ipsam aut sed qui repellat aliquam est
              iste.
            </p>
            <p class="contactfirst">
              not sure ? <a href="./contact/contact.html">contact first</a>
            </p>
          </div>
